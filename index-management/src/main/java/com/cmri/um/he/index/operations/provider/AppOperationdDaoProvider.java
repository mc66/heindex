...
public class AppOperationdDaoProvider {
    public String saveAll(Map map) {
        ...
        sb.append("VALUES ");
        MessageFormat mf = new MessageFormat("(null,#'{'list[{0}].app},#'{'list[{0}].category},#'{'list[{0}].content},#'{'list[{0}].channel},#'{'list[{0}].tariff},#'{'list[{0}].service},#'{'list[{0}].market},#'{'list[{0}].experience},null,#'{'list[{0}].version},#'{'list[{0}].month},#'{'list[{0}].atime})");
