...
public interface AppMauMapper {
     ...
     * @return 应用月活集合
     */
    @Select("SELECT category.id AS category_id,app.id AS app_id, category.name AS category, app.name AS app, logo.logo, active.mau, active.basis,active.month AS month " +
