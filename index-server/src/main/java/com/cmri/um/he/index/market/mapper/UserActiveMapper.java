...
public interface UserActiveMapper {
    ...
    @Select(" SELECT amw.`week`,amw.month_active_rate,amw.weeky_active FROM app_market_week amw WHERE amw.app=#{app} and amw.`week` BETWEEN #{month1} and #{month2} ")
    List<Map<String,Object>> queryActivityWeekList(@Param("month1") String month1, @Param("app")int app,@Param("month2") String month2);
    @Select(" SELECT amd.date,amd.dately_active,amd.date_active_rate FROM app_market_date amd WHERE amd.app=#{app} and amd.date BETWEEN #{month1} and #{month2} ")
    ...
    @Select(" SELECT amw.`week`,amw.weekly_active_day_per_person,amw.weekly_low_freq_user_rate FROM app_market_week amw WHERE WHERE amw.app=#{app} and amw.`week` BETWEEN #{month1} and #{month2} ")
    List<Map<String,Object>> queryNumberDayWeekList(@Param("month1") String month1, @Param("app")int app,@Param("month2") String month2);
    @Select(" SELECT amd.date,amd.dately_low_freq_user_rate,amd.dately_active_day_per_person FROM app_market_date amd WHERE amd.app=#{app} and amd.date BETWEEN #{month1} and #{month2} ")
    ...
    @Select(" SELECT amw.`week`,amw.weekly_duration_per_person,amw.weekly_dataflow_per_person FROM app_market_week amw WHERE amw.app=#{app} and amw.`week` BETWEEN #{month1} and #{month2} ")
    List<Map<String,Object>> queryBehaviorWeekList(@Param("month1") String month1, @Param("app")int app,@Param("month2") String month2);
    @Select(" SELECT amd.date,amd.dately_duration_per_person,amd.dately_dataflow_per_person FROM app_market_date amd WHERE amd.app=#{app} and amd.date BETWEEN #{month1} and #{month2} ")
    ...
    @Select(" SELECT amw.`week`,amw.weekly_duration_per_person,amw.weekly_dataflow_per_person,amw.new_user,amw.weeky_active,amw.weekly_active_day_per_person,amw.weekly_low_freq_user_rate FROM app_market_week amw WHERE amw.app=#{app} and amw.`week` BETWEEN #{month1} and #{month2} ")
    List<Map<String,Object>> queryStatisticalWeekList(@Param("month1") String month1, @Param("app")int app,@Param("month2") String month2);
    @Select(" SELECT amd.date,amd.dately_duration_per_person,amd.dately_dataflow_per_person,amd.new_user,amd.dately_active,amd.dately_active_day_per_person,amd.dately_low_freq_user_rate FROM app_market_date amd WHERE amd.app=#{app} and amd.date BETWEEN #{month1} and #{month2} ")
