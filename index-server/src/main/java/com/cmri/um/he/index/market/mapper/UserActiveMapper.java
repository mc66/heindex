...
public interface UserActiveMapper {
    ...
    @Select(" SELECT am.`month`,am.monthly_active as mau_number,am.month_active_rate as month_active_rate,am.monthly_active_day_per_person,am.monthly_dataflow_per_person,am.monthly_duration_per_person,am.monthly_low_freq_user_rate FROM app_market_month am WHERE am.app=#{app} and am.`month` BETWEEN #{month1} and #{month2} ")
